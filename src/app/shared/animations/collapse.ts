...
export function collapseAnimation(ms = 400, type = 'cubic-bezier(0.4,0.0,0.2,1)'): AnimationTriggerMetadata {
...
export function collapseIconAnimation(ms = 200): AnimationTriggerMetadata {
